  ...
  return (
    ...
    >
      ...
      <SelectPrimitive.Icon asChild>
        <ChevronDown className="h-4 w-4 opacity-50 flex-shrink-0 ms-2" />
...
function SelectLabel({ className, ...props }) {
  return <SelectPrimitive.Label className={cn("py-1.5 ps-2 pe-8 text-sm font-semibold text-muted-foreground", className)} {...props} />;
}
